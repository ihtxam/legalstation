# Data Residency Certificate — LexFlow

**Certificate ID:** DR-[YYYY]-[NNNN]  
**Issued to:** [Customer / Law firm]  
**Issued by:** [LexFlow operator]  
**Valid from:** [date] **to:** [date]

## Declaration

We certify that, for the LexFlow environment identified below, primary application data (database and document object storage) is configured to reside in:
