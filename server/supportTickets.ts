  ...
  const html = `
    <html><body style="font-family:sans-serif;color:#1a1a1a">
      <div style="max-width:600px;margin:0 auto;padding:20px">
        <h2 style="color:#7C3AED">New support ticket ${esc(opts.ticketNumber)}</h2>
...
export async function notifyTicketReply(opts: {
  ...
  const html = `
    <html><body style="font-family:sans-serif;color:#1a1a1a">
      <div style="max-width:600px;margin:0 auto;padding:20px">
        <h2 style="color:#7C3AED">Reply on ${esc(opts.ticketNumber)}</h2>
...
export async function notifyTicketStatusChange(opts: {
  ...
  const html = `
    <html><body style="font-family:sans-serif;color:#1a1a1a">
      <div style="max-width:600px;margin:0 auto;padding:20px">
        <h2 style="color:#7C3AED">Ticket ${esc(opts.ticketNumber)} updated</h2>
